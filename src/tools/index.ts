...
import "./definitions/callLogsService/index.js"; // Call-logs service (all groups)
...
import "./definitions/driveService/index.js"; // Drive / file-storage service (all groups)
